...
- The **Upstreams** panel on a site's page shows what this node has observed of each backend — in rotation, failing, switched off, or out and when it will be tried again. A site can never be left with nothing to forward to.
