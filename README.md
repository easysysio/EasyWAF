...
* **No audit log.** Nothing records who changed what. Scheduled for **0.8.0** — deliberately
...
* **No backup, restore or configuration export.** Everything lives in one SQLite file with no
  ...
  **0.10.0**; until then, copy the database file with the service stopped.
